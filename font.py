...
# 그래픽 게임 화면에 글자를 그리기
# "글자를 그린다는 표현대로 ..."
# 1. 폰트 종류와 폰트 크기를 세팅합니다. => 아래 scoreInit 함수
# 2. 드로잉 루프 안에서 표시할 폰트를 변환하여 폰트 스크린뷰를 얻습니다. => 아래 drawScore 함수
# 3. 폰트가 그려질 스크린뷰에서 폰트 영역(사각영역)을 구합니다.
# 4. 전체 스크린에 폰트 스크린뷰와 영역을 찍습니다.(blit)
